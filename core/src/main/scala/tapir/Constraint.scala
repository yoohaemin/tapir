...
object CanConstraint {
  ...
  implicit object CanEnumFloat extends CanConstraint[Schema.SInteger, Constraint.Enum[Float]]
  implicit object CanEnumDouble extends CanConstraint[Schema.SInteger, Constraint.Enum[Double]]
